...
function Navbar() {
    ...
    return (
        <nav aria-label="navigation">
            ...
            <ul role="navigation" onClick={toggleNav} className="nav-links undecorated-list" 
                style={size <= 1048 ? navActive ? { transform: "translateX(0%)" } : { transform: "translateX(100%)" } : {}}>
            ...
            <LangSelector role="language-selector" />
            <button aria-label="mobile-menu-burger" type="button" className="mobile-nav" 
                style={navActive ? { backgroundColor: "lightgrey" } : { backgroundColor: "white" }} onClick={toggleNav}>
